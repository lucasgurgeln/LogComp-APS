...
#line 1 "petcarelang.y"

#include <stdio.h>
void yyerror(const char *s);
extern int yylex();

#line 77 "petcarelang.tab.c"
...
static const char *const yytname[] =
{
  ...
  "PET", "LBRACE", "RBRACE", "SEMICOLON", "$accept", "program",
